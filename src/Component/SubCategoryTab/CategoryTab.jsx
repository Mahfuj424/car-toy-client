...
const CategoryTab = () => {
    ...
    return (
        <div className='my-10 pb-10 bg-blue-300 rounded-xl px-4 container'>
            <h1 className='text-center text-3xl font-semibold pt-5 my-5'>Sub Category <span className='text-blue-500'>Toy</span></h1>
            <Tabs>
